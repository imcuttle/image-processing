...
public class ParametersI extends JPanel
{
	...
	public ParametersI()
	{
		...
		setBorder(new CompoundBorder(
				BorderFactory.createTitledBorder("选锟斤拷锟斤拷锟斤拷(x1,y1)锟斤拷(x2,y2)"),
				BorderFactory.createEmptyBorder(10, 10, 50, 10)));
	}

	public ParametersI(String note, String sx1, String sy1,
					   String sx2,  String sy2, String sx3)             //5锟斤拷锟斤拷钮
	{
	...
	public ParametersI(String note, String sx1, String sy1,
					   String sx2, String sy2)                         //4锟斤拷锟斤拷钮
	{
		CheckboxGroup cbg = new CheckboxGroup();
		x1box = new Checkbox(sx1, cbg, true);
		y1box = new Checkbox(sy1, cbg, true);
	...
	public ParametersI(String note, String sx1, String sy1, String sx2)//3锟斤拷锟斤拷钮
	{
		CheckboxGroup cbg = new CheckboxGroup();
		x1box = new Checkbox(sx1, cbg, true);
		y1box = new Checkbox(sy1, cbg, true);
